...
public class Blade {
    ...
    private /*Vector*/List<String> bases;

    public Blade() {
        bases = new /*Vector*/ArrayList<>();
    }

    public Blade(String[] bases) {
        this.bases = new /*Vector*/ArrayList<>(Arrays.asList(bases));
    }

    public Blade(/*Vector*/List<String> bases) {
        this.bases = bases;
    }

    public Blade(TCBlade b) {
        this.bases = new /*Vector*/ArrayList<>(Arrays.asList(b.getBase()));
    }
    ...
    public /*Vector*/List<String> getBases() {
        return bases;
    }
    ...
    // wer ruft das auf
    //FIXME vielleicht ist das der Grund warum es nicht mehr funktioniert mit der Tabelle
