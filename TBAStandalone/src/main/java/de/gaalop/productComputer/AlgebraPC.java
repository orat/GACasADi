...
public class AlgebraPC {
    ...
    public String[] base;
    public String[] base2;
    public Map<String, Byte> baseSquaresStr;
    public Map<String, List<BladeStr>> mapToPlusMinus;
    public Map<String, List<BladeStr>> mapToZeroInf;
     ...
     */
    private Map<String, List<BladeStr>> parseMapStringListBladeStr(String str) {
        HashMap<String, List<BladeStr>> result = new HashMap<>();
     ...
     */
    private List<BladeStr> parseListBladeStr(String str) {
        int index;
