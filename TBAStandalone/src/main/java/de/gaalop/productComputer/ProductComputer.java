...
public class ProductComputer {
    ...
    private Map<Integer, SumOfBlades> mapZIToPM;
    private Map<Integer, SumOfBlades> mapPMToZI;

    private SumOfBlades[] bladeListPM;
    private Map<Blade, Integer> mapBladeToIndex;
     ...
     */
    private void initializeMap(String[] base, String[] base2, Map<String, 
                               List<BladeStr>> source, Map<Integer, SumOfBlades> dest) {
        for (String baseElement: source.keySet()) {
            List<BladeStr> list = source.get(baseElement);
    ...
    */
    ...
    private void group(SumOfBlades sumOfBlades) {
        HashMap<Blade, Float> map = new HashMap<>();
