...
public class GaFunctionCache<CACHED extends ICached<CACHED, EXPR, VAR, VAL>, EXPR extends GaMvExpr<EXPR, VAR, VAL>, VAR extends IGaMvVariable<EXPR, VAR, VAL>, VAL extends IGaMvValue<EXPR, VAR, VAL>>
