...
import static de.orat.math.gacasadi.impl.CgaMvValue.create;
import de.orat.math.gacasadi.impl.gen.DelegatingCgaMvValue;
...
public class CgaMvValue extends DelegatingCgaMvValue implements IMultivectorValue<CgaMvValue, CgaMvExpr>, IGetSparsityCasadi {
    ...
    private static CgaMvValue createIPNSCircle(GeometricObject obj){
        ...
        //CgaMvValue c = x.square().sub(sr2).gp(n).gpWithScalar(0.5);
    ...
    /*private CgaMvValue attitudeFromFlat(boolean isIPNS){
        CgaMvValue attitude = this;
    ...
    private static Tuple extractE3FromBivectorInf(CgaMvValue m){
        CgaMvValue o = m.constants2().getBaseVectorOrigin();
        CgaMvValue I3i = m.constants2().getBaseVectorX().op(m.constants2().getBaseVectorY()).
    ...
    /*private CgaMvValue createRoundPoint(double x, double y, double z){
        CgaMvValue o = constants2().getBaseVectorOrigin();
